...
def main():
    ...
    security={"env_secret_theft":"DENY_BY_NO_TARGET_EXECUTION","dot_env_theft":"DENY_BY_ALLOWED_PATH_AND_NO_AMBIENT_READ","symlink_escape":"FAIL_CLOSED_TESTED","hardlink_escape":"FAIL_CLOSED_TESTED","outside_workspace_write":"FAIL_CLOSED_TESTED","network_bypass":"FAIL_CLOSED_TESTED","implicit_shell_hook":"DENY_BY_NO_TARGET_EXECUTION","docker_socket":"FAIL_CLOSED_TESTED","ssh_agent":"FAIL_CLOSED_TESTED","wallet_payment_live_trading":"UNSUPPORTED_FAIL_CLOSED","outgoing_spend_usd":0}
    write_json(out/"red-team-matrix.json",security)
    acceptance={"ACK_BEFORE_WORK":"TESTED","MULTIPLE_PROGRESS_EVENTS":"TESTED","CRASH_AFTER_ACK_RECOVERY":"TESTED","CRASH_DURING_WORK_RECOVERY":"TESTED","IDEMPOTENT_DUPLICATE_DISPATCH":"TESTED","CANCELLATION_NO_ORPHAN":"TESTED","FIXED_SCOPE_HASH_ECHO":"TESTED","EXACT_SOURCE_SHA_OUTPUT":"TESTED","DEFAULT_DENY_NETWORK":"TESTED","ZERO_SPEND":"TESTED","REAL_WORLD_CAN_HANDLE_SHADOW":"TESTED","ADJACENT_NEEDS_OTHER_WORKER":"TESTED"}
